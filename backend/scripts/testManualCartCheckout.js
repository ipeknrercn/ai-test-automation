/**
 * Manuel test — SauceDemo sepet + checkout (tek koşum).
 *
 * Senaryo: benchmarkCases.js → saucedemo-cart
 * Benchmark: node scripts/runBenchmark.js --case saucedemo-cart
 */
