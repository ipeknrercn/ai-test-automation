/**
 * Manuel test — Remora contact formu (tek koşum).
 *
 * Senaryo: benchmarkCases.js → remora-contact
 * Benchmark: node scripts/runBenchmark.js --case remora-contact
 */
